...
A = C.StringtoTree(conjunciones, letrasProposicionales)

print(u"Trabajando con la fórmula:\n ",C.Inorder(A))

A =C.quitarDobleNegacion(A)

print(u"La fórmula sin dobles negaciones es:\n ",C.Inorder(A))

A =C.reemplazarImplicacion(A)
...
OK = True
while OK:
    OK, A =C.aplicaDistributiva(A)

conjuntoClausulas =C.formaClausal(A)
...
inter={}
OK, INTS = D.DPLL(conjuntoClausulas,inter,letrasProposicionales,)
